...
class AmountTimer extends StatefulWidget {
  final double set, rest, amount;

  AmountTimer({this.set, this.rest, this.amount});
  AmountTimerState createState() => AmountTimerState();
}

class AmountTimerState extends State<AmountTimer> {
  int number1 = 0, number2 = 1, number3 = 0, number4 = 0, amount;
  double activeTime, rest;
  bool isActive, firstTime;
